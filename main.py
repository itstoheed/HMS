...
# @login_required
# def ddetails():
#     posts=Doctors.query.all()
#     # posts=db.engine.execute("SELECT * FROM `doctors`")
#     return render_template('ddetail.html',posts=posts)
...
#             flash("Enu Lahore le Jao","danger")
#     return render_template('index.html')
